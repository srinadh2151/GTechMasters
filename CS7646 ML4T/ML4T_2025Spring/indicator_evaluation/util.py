...
# /Users/srinadh.nidadana-c/Documents/Academics/GTechMasters/CS7646 ML4T/ML4T_2025Spring/indicator_evaluation/util.py

def symbol_to_path(symbol, base_dir=None):
    """Return CSV file path given ticker symbol."""
    if base_dir is None:
        # base_dir = os.environ.get("MARKET_DATA_DIR", "../data/")
        base_dir = os.environ.get("MARKET_DATA_DIR", "/Users/srinadh.nidadana-c/Documents/Academics/GTechMasters/CS7646 ML4T/ML4T_2025Spring/data/")
...
def get_data(symbols, dates, addSPY=True, colname="Adj Close"):
    ...
    for symbol in symbols:
        ...
        print('Testing the Path for - ', symbol, symbol_to_path(symbol))
        df_temp = pd.read_csv(
