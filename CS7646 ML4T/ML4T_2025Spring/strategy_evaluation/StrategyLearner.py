...
class IndicatorDiscretizer(object):
    ...
    def relative_strength_index_max_bucket(self):
        """The largest bucket for the Relative Strength Index indicator"""
        return 4
    ...
    def relative_strength_index(self, rsi):
        """Discretizes the Relative Strength Index indicator"""
        # Typical range for rsi: 0 to 100
        # Four buckets
        # 1. x < 30 (oversold bucket)
        # 2. 30 <= x <= 70 (no indication)
        # 3. x > 70 (overbought bucket)
...
class TradingStateFactory(object):
    ...
    def _compute_number_of_states(self):
        ...
        all_buckets = [
            ...
            self._indicator_discretizer.relative_strength_index_max_bucket #money_flow_index_max_bucket
        ]
    ...
    def _discretize(self, indicators):
        ...
        discretized_rsi = self._indicator_discretizer.relative_strength_index(rsi) #money_flow_index(rsi)
